...
public class RepositoriesTest {
    ...
    public void testStudyRepository() {
        ...
        ShortCircuitParametersEntity shortCircuitParametersEntity = new ShortCircuitParametersEntity(false, false, false, false, StudyType.TRANSIENT, 1, false, false, false, false, ShortCircuitTypePlanTension.NOMINAL);
        ...
        LoadFlowParametersEntity loadFlowParametersEntity2 = new LoadFlowParametersEntity(LoadFlowParameters.VoltageInitMode.UNIFORM_VALUES,
                ...
                true, LoadFlowParameters.BalanceType.PROPORTIONAL_TO_CONFORM_LOAD, true,
                countriesTemp, LoadFlowParameters.ConnectedComponentMode.MAIN, false, 0.95, List.of());
        ShortCircuitParametersEntity shortCircuitParametersEntity2 = new ShortCircuitParametersEntity(true, true, false, true, StudyType.STEADY_STATE, 0, false, false, false, false, ShortCircuitTypePlanTension.NOMINAL);
        ...
        ShortCircuitParametersEntity shortCircuitParametersEntity3 = new ShortCircuitParametersEntity(true, false, false, true, StudyType.SUB_TRANSIENT, 10, false, false, false, false, ShortCircuitTypePlanTension.NOMINAL);
