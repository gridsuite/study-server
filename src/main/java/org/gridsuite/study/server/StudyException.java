...
public class StudyException extends RuntimeException {
    ...
    public enum Type {
        ...
        PCC_MIN_NOT_FOUND,
        PCC_MIN_ERROR,
        CREATE_PCC_MIN_PARAMETERS_FAILED,
        UPDATE_PCC_MIN_PARAMETERS_FAILED,
        DELETE_PCC_MIN_PARAMETERS_FAILED,
        GET_PCC_MIN_PARAMETERS_FAILED,
        PCC_MIN_PARAMETERS_NOT_FOUND,
