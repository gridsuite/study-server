...
public enum StudyBusinessErrorCode implements BusinessErrorCode {
    ...
    CREATE_PCC_MIN_PARAMETERS_FAILED("study.createPCCMinParametersFailed"),
    UPDATE_PCC_MIN_PARAMETERS_FAILED("study.updatePCCMinParametersFailed"),
    DELETE_PCC_MIN_PARAMETERS_FAILED("study.deletePCCMinParametersFailed"),
    GET_PCC_MIN_PARAMETERS_FAILED("study.getPCCMinParametersFailed"),
    PCC_MIN_PARAMETERS_NOT_FOUND("study.pccMinParametersNotFound"),
