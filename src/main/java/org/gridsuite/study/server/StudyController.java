...
public class StudyController {
    ...
    public ResponseEntity<String> getVoltageLevelIdForBranchOrThreeWindingsTransformerBySide(
            @PathVariable("studyUuid") UUID studyUuid,
            @PathVariable("nodeUuid") UUID nodeUuid,
        ...
        String voltageLevelId = studyService.getVoltageLevelIdByEquipmentIdAndSide(studyUuid, nodeUuid, inUpstreamBuiltParentNode, equipmentId, side);
