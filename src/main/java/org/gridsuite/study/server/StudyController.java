...
public class StudyController {
    ...
    public ResponseEntity<Mono<Void>> changeSwitchState(@PathVariable("studyUuid") UUID studyUuid,
        ...
        return ResponseEntity.ok().body(studyService.assertCanModify(studyUuid, nodeUuid).then(studyService.assertComputationNotRunning(nodeUuid))
    ...
    public ResponseEntity<Mono<Void>> applyGroovyScript(@PathVariable("studyUuid") UUID studyUuid,
        ...
        return ResponseEntity.ok().body(studyService.assertCanModify(studyUuid, nodeUuid).then(studyService.assertComputationNotRunning(nodeUuid)).then(studyService.applyGroovyScript(studyUuid, groovyScript, nodeUuid).then()));
    }
    ...
    public ResponseEntity<Mono<Void>> changeLineStatus(
        ...
        return ResponseEntity.ok().body(studyService.assertCanModify(studyUuid, nodeUuid).then(studyService.assertComputationNotRunning(nodeUuid)).then(studyService.changeLineStatus(studyUuid, lineId, status, nodeUuid)));
    }
    ...
    public ResponseEntity<Mono<Void>> runLoadFlow(
            @PathVariable("studyUuid") UUID studyUuid,
            @PathVariable("nodeUuid") UUID nodeUuid) {
        return ResponseEntity.ok().body(studyService.assertCanModify(studyUuid, nodeUuid).then(studyService.assertLoadFlowRunnable(nodeUuid))
