...
public class StudyController {
    ...
    public ResponseEntity<List<IdentifiableInfos>> getVoltageLevelBusesOrBusbarSections(
        ...
        return ResponseEntity.ok().contentType(MediaType.APPLICATION_JSON).body(studyService.getVoltageLevelBusesOrBusbarSections(studyUuid, nodeUuid, voltageLevelId, inUpstreamBuiltParentNode));
    }
    ...
    public ResponseEntity<String> getVoltageLevelSubstationId(
            ...
            @Parameter(description = "Should get in upstream built node ?") @RequestParam(value = "inUpstreamBuiltParentNode", required = false, defaultValue = "false") boolean inUpstreamBuiltParentNode) {
        return ResponseEntity.ok().body(studyService.getVoltageLevelSubstationId(studyUuid, nodeUuid, voltageLevelId, inUpstreamBuiltParentNode));
    }
    ...
    public ResponseEntity<String> getNetworkAllElementsInfos(
            @PathVariable("studyUuid") UUID studyUuid,
            @PathVariable("nodeUuid") UUID nodeUuid,
            @Parameter(description = "Substations id") @RequestParam(name = "substationId", required = false) List<String> substationsIds) {

        return ResponseEntity.ok().contentType(MediaType.APPLICATION_JSON).body(studyService.getNetworkAllElementsInfos(studyUuid, nodeUuid, substationsIds));
    }
