...
public class StudyController {
    ...
    public ResponseEntity<String> getNeworkAreaDiagram(
            ...
            @Parameter(description = "Initialize NAD with Geographical Data") @RequestParam(name = "initGeoData", defaultValue = "true") boolean initGeoData) {
        String result = studyService.getNetworkAreaDiagram(studyUuid, nodeUuid, voltageLevelsIds, depth, initGeoData);
        return result != null ? ResponseEntity.ok().contentType(MediaType.APPLICATION_JSON).body(result) :
            ResponseEntity.noContent().build();
    }
