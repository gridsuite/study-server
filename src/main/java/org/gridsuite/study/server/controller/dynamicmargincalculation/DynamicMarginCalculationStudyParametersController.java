...
public class DynamicMarginCalculationStudyParametersController {

    private final DynamicMarginCalculationService dynamicMarginCalculationService;

    public DynamicMarginCalculationStudyParametersController(DynamicMarginCalculationService dynamicMarginCalculationService) {
