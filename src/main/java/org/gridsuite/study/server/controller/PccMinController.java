...
public class PccMinController {
    ...
    public PccMinController(PccMinService pccMinService) {
    ...
    public ResponseEntity<String> getPccMinParameters(@PathVariable UUID parameterUuid) {
        return ResponseEntity.ok().contentType(MediaType.APPLICATION_JSON).body(pccMinService.getPccMinParameters(parameterUuid));
    }
}
