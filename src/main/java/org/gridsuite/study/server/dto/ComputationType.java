...
public enum ComputationType {
    ...
    LOAD_FLOW_WITH_TAP_CHANGERS("Load flow with ratio tap changers", "loadFlowWithRatioTapChangersResultUuid",
        NotificationService.UPDATE_TYPE_LOADFLOW_WITH_RATIO_TAP_CHANGERS_STATUS, NotificationService.UPDATE_TYPE_LOADFLOW_WITH_RATIO_TAP_CHANGERS_RESULT,
        NotificationService.UPDATE_TYPE_LOADFLOW_WITH_RATIO_TAP_CHANGERS_FAILED),
