...
public enum RootNetworkAction {
    ...
    RootNetworkAction(String label, String resultUuidLabel, String updateStatusType, String updateResultType, String updateFailedType) {
        this.label = label;
